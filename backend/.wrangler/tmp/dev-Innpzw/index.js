...
// .wrangler/tmp/bundle-RIdQJ0/checked-fetch.js
...
var app = new Hono2();
app.use("/*", cors());
var checkAuth = /* @__PURE__ */ __name((c) => {
...
app.get("/api/categories", async (c) => {
  try {
    ...
    const stringifiedResults = results.map((cat) => ({
      ...cat,
      id: String(cat.id),
  ...
  try {
    ...
    const response = await fetch(`${baseUrl}/chat/completions`, {
      ...
      body: JSON.stringify({
        model,
        messages: [
          { role: "system", content: "\u4F60\u5C06\u4E3A\u4E00\u7BC7\u6539\u9769\u5B97\u8BB2\u9053\u6587\u672C\u64B0\u5199\u6458\u8981\uFF0C\u53D1\u5E03\u4E8E\u535A\u5BA2\uFF0C\u7528\u4E8E\u5438\u5F15\u8BFB\u8005\u70B9\u51FB\u9605\u8BFB\u5168\u6587\u3002\u8BF7\u9075\u5B88\u4EE5\u4E0B\u8981\u6C42\uFF1A                                          \u2022 \u5185\u5BB9\u957F\u5EA6\u7EA6\u4E3A80\u5B57                                          \u2022 \u4F7F\u7528\u4E2D\u6587\u8868\u8FBE                                          \u2022 \u91C7\u7528\u63D0\u95EE\u5F0F\u6216\u5F15\u4EBA\u601D\u8003\u7684\u65B9\u5F0F\uFF0C\u63D0\u9AD8\u5438\u5F15\u529B                                          \u2022 \u5C06\u201C\u8BB2\u9053\u201D\u4F5C\u4E3A\u51FA\u5904\u79F0\u547C\uFF0C\u4E0D\u63D0\u53CA\u4F5C\u8005\u3001\u8BB2\u5458\u59D3\u540D\u6216\u4EFB\u4F55\u5F15\u7528\u6765\u6E90                                          \u2022 \u4E0D\u51FA\u73B0\u7ECF\u6587\u5F15\u7528\u3001\u7AE0\u8282\u7F16\u53F7\u3001\u811A\u6CE8\u6216\u94FE\u63A5                                          \u2022 \u4E0D\u8FC7\u5EA6\u5267\u900F\u4E3B\u8981\u8BBA\u8BC1\u4E0E\u7ED3\u8BBA\uFF0C\u8981\u6FC0\u53D1\u8BFB\u8005\u597D\u5947\u5FC3                                          \u2022 \u4FDD\u6301\u903B\u8F91\u8FDE\u8D2F\u3001\u4E25\u8083\u5E84\u91CD\uFF08\u7B26\u5408\u6539\u9769\u5B97\u98CE\u683C\uFF09\uFF0C\u4F46\u8BED\u6C14\u5177\u5F15\u5BFC\u6027\u548C\u547C\u53EC\u6027                                          \u2022 \u907F\u514D\u5938\u5F20\u53E3\u53F7\u548C\u7A7A\u6D1E\u60C5\u7EEA\u5316\u8868\u8FBE                                          \u8F93\u51FA\u683C\u5F0F\u8981\u6C42\uFF1A                                          \u53EA\u8FD4\u56DE\u6700\u7EC8\u6458\u8981\u5185\u5BB9\uFF0C\u4E0D\u6DFB\u52A0\u4EFB\u4F55\u5907\u6CE8\u3001\u524D\u7F00\u3001\u6807\u9898\u3001\u89E3\u91CA\u6216\u63D0\u793A\u8BED\u3002" },
          { role: "user", content: content.substring(0, 4e3) }
        ],
        stream: false
      })
    });
...
// .wrangler/tmp/bundle-RIdQJ0/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RIdQJ0/middleware-loader.entry.ts
