  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16 space-y-6">
        <span className="inline-block py-1 px-3 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-sm font-semibold tracking-wide uppercase">
          全新发布 v1.0
        </span>
        <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight font-serif">
          访问古道 App
        </h1>
        <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed">
          基于现代 <span className="text-slate-900 dark:text-white font-semibold">Expo</span> 架构重构，
          为您提供原生级的流畅交互与极致的阅读体验。
        </p>
        
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <a 
              href="https://media.ancientpath.dpdns.org/app/ancientpath-3896621b-a5b8-4a7a-a94b-e3e45f13b8de.apk" 
              download
      ...
      <div className="mb-20">
        <h2 className="text-3xl font-bold text-center text-slate-900 dark:text-white mb-10 font-serif">
          界面概览
        </h2>
      ...
      <div className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-800/50 dark:to-slate-900 rounded-3xl p-8 md:p-10 border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden">
        ...
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-8 flex items-center relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 relative z-10">
            ...
            <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-6 rounded-2xl border border-green-100 dark:border-green-900/30 shadow-sm hover:shadow-md transition-shadow">
                <h3 className="font-bold text-lg text-slate-900 dark:text-white mb-3 flex items-center">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
                    安全无毒
                </h3>
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
                     APK 安装包已通过 <span className="font-semibold text-slate-900 dark:text-white">VirusTotal</span> 全球 65 款主流杀毒引擎的严格检测，您可以点击查看 <a href="https://www.virustotal.com/gui/file/e070eadfa7669eec7220b3f9b37e9b8ae56769d46a8120253e05f0b20c36e409?nocache=1" target="_blank" rel="noreferrer" className="text-blue-600 underline font-medium">完整检测报告</a>。
                </p>
            ...
            {/* Installation Help */}
            <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-6 rounded-2xl border border-blue-100 dark:border-blue-900/30 shadow-sm hover:shadow-md transition-shadow">
                 <h3 className="font-bold text-lg text-slate-900 dark:text-white mb-3 flex items-center">
                ...
                <ul className="text-sm text-slate-600 dark:text-slate-400 space-y-3">
                    <li className="flex items-start">
                        <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-blue-500 mt-1.5 mr-2"></span>
...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; description: string }> = ({ icon, title, description }) => (
  <div className="flex items-start p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
    <div className="flex-shrink-0 p-3 bg-slate-50 dark:bg-slate-800 rounded-xl mr-5 text-blue-600 dark:text-blue-400">
      {icon}
    </div>
    <div>
